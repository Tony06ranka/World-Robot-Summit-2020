#ifndef WAYPOINT_LOADER_WRS_WAYPOINT_LOADER_WRS_H_INCLUDED
#define WAYPOINT_LOADER_WRS_WAYPOINT_LOADER_WRS_H_INCLUDED
...
#endif  //WAYPOINT_LOADER_WRS_WAYPOINT_LOADER_WRS_H_INCLUDED
